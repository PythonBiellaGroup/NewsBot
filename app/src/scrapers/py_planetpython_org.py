...
def planetpython_scraper(defUrl="https://planetpython.org/", defNum=10):
    ...
    for link in linkList[0:defNum]:
        ...
        try:
            ...
            testo = link.find_next_sibling("p").get_text().strip()
            if testo:
...
def test_scraper():
    alist, blist, clist, dlist = planetpython_scraper()
