...
def hackertab_scraper(defUrl="https://hackertab.dev/topics/python", defNum=20):
    today = adesso()
    # Init outputs
    titleList = []
    llList = []
    ...
    # ora, titolo, link
    linkList = bsObj.findAll("h3", {"class": "text-xs font-medium m-0 p-0"})
...
def test_scraper():
    alist, blist, clist, dlist = hackertab_scraper()
